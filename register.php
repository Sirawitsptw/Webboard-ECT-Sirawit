...
<body>
    ...
    <form>
        <table style = "border: 2px solid black; width: 40%;" align="center">
            ...
            <tr><td>รหัสผ่าน : </td><td><input type = "text" name = "pass" size = "50" required></td></tr>
            <tr><td>ชื่อ - นามสกุล : </td><td><input type = "text" name = "namename" size = "50"required></td></tr>
            <tr><td>เพศ : </td><td><input type = "radio" name = "gender" value = "male">ชาย
            <br>
            <input type = "radio" name = "gender" value = "female">หญิง
            <br>
            <input type = "radio" name = "gender" value = "other">อื่นๆ
            </td></tr>
            <tr><td>อีเมลล์  : </td><td><input type = "email" name = "email" size = "50" required></td></tr><br>
